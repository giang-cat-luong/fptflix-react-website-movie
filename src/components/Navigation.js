    ...
    <AppBar position="static" style={{ backgroundColor: theme.backgroundColor, color: theme.color }}>
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          ...
          >
            <img className='logo' src="https://i.ibb.co/Q9s1rF9/S-500-100-px-1.png" style={{paddingBottom:'7px'}} />
          </Typography>
          ...
          <Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex' } }}>
            <Link style={{ color: theme.color ,paddingRight:'20px',textDecoration:'none'}} to='/'><Icon left>home</Icon>Home</Link>
