...
import { TextField, FormControl, InputLabel, Select, MenuItem, FormControlLabel, Typography, Grid,Dialog,DialogTitle,DialogContent,DialogContentText,Alert,AlertTitle,DialogActions} from '@mui/material';
...
export default function Add() {
    ...
    const formik = useFormik({
        ...
        validationSchema: Yup.object({
            ...
            trailer: Yup.string().required("Required.").min(5, "Must be 5 characters or more"),
            year: Yup.number().integer().typeError("Please enter a valid number"),
            nation: Yup.string().required("Required.").min(5, "Must be 5 characters or more"),
    ...
    return (
        <div  style={{ paddingBottom: "30px",backgroundImage: `url("https://cdn.popsww.com/blog-kids/sites/3/2022/04/songoku.jpg")`}}>
            <Container>
            <form onSubmit={formik.handleSubmit}  >
                <Grid container alignItems="center" justify="center" direction="column" >
                    ...
                    <Grid item>
                        ...
                        <br />
                        {formik.errors.genres && formik.touched.genres && (<Typography variant="caption" color="red">{formik.errors.genres}</Typography>)}
                    </Grid>
                    <Grid item>
                        <TextField sx={{ m: 1, minWidth: 300 }}
                            label="Time"
                        ...
                        />
                        <br />
                        {formik.errors.time && formik.touched.time && (<Typography variant="caption" color="red">{formik.errors.time}</Typography>)}
                    </Grid>
                    <Grid item>
                        <TextField sx={{ m: 1, minWidth: 300 }}
                            id="outlined-multiline-static"
                    ...
                    <Grid item>
                        <FormControlLabel control={<Switch />} label="Adult film" name='adult'
