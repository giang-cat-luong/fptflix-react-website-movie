...
export default function Update() {
    ...
    const update = () => {
        ...
        fetch(`https://63609d88af66cc87dc172e0f.mockapi.io/movies/${name.id}`, {
            method: 'PUT',
            headers: {
                                            ...
                                            <Grid container spacing={1}>
                                                ...
                                                <Grid item xs={12}>
                                                    <FormControlLabel control={<Switch />}
                                                        label="Adult movie."
                                                        name='adult'
                                                        value={formik.values.adult} onClick={formik.handleChange}
                                                    />
                                                    {formik.errors.adult && (<Typography variant="caption" color="red">{formik.errors.adult}</Typography>)}
                                                    <Button
